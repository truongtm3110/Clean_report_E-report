...
from app.schemas.report_free.response_report_free import ResponseReportDetailBase
...
class ProductStatistic(SQLModel):
    ...
    order_revenue_30d: int | None = None
...
class ResponseReportDetailMarketing(ResponseReportDetailBase):
    url_report_pdf: str | None = None
    data_analytic: dict | None = None
